        ...
        try {
            ...
            await axiosClient.post("/uploadFile", formData, {
                ...
                const categoryList = {
                    ...
                    "slide": images,
                    "suonXe": values.suonXe,
                    "loaiPhanhThang": values.loaiPhanhThang,
                    "boLip": values.boLip,
                    "boDia": values.boDia,
                    "loaiTayDe": values.loaiTayDe,
                    "phuoc": values.phuoc,
        ...
        (async () => {
            try {
                ...
                form2.setFieldsValue({
                    ...
                    quantity: response.product.quantity,
                    suonXe: response.product.suonXe,
                    loaiPhanhThang: response.product.loaiPhanhThang,
                    boLip: response.product.boLip,
                    boDia: response.product.boDia,
                ...
                >
                    ...
                    >
                        ...
                        <Form.Item
                            ...
                            style={{ marginBottom: 10 }}
                        >
                            <Input placeholder="Sườn xe" />
                        </Form.Item>

                        <Form.Item
                            name="loaiPhanhThang"
                            label="Loại phanh thắng"
                            style={{ marginBottom: 10 }}
                        >
                            <Input placeholder="Loại phanh thắng" />
                        </Form.Item>
